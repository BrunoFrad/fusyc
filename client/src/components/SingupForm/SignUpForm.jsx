export default function SignUpForm() {
    ...
    return(
        ...
        <form className="flex items-center font-bold text-neutral-300 bg-neutral-800 w-5/6 h-5/6 rounded-3xl shadow-xl" action="http://localhost:3000/api/login" method="GET">
            <div className="flex flex-col items-center justify-evenly h-5/6 w-full">
                ...
                <label className="input input-bordered flex items-center gap-2 bg-neutral-800">
                    ...
                    <input type="password" className="grow" placeholder="Confirmar a senha" />
                </label>
